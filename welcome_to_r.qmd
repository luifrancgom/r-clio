...
![R: Motor](images/chap-1-fig-1-1.png){fig-alt="Un motor de un automóvil representando a R como el núcleo de procesamiento de datos."}

![Positron: Tablero de control](images/chap-1-fig-1-2.png){fig-alt="Un tablero de control de un automóvil representando a Positron como la interfaz para controlar el motor."}
