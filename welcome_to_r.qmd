...
![R: **No** dar click sobre este ícono](images/r-project-logo.png){#fig-r-icon width=26%}

![Positron: Dar click sobre este ícono](images/positron-logo.png){#fig-positron-icon width=20%}
