...
Si abandonamos la analogía anterior y sómos más específicos, R es un lenguaje de programación y Positron es un [*Entorno Integrado de Desarrollo (IDE)*](https://es.wikipedia.org/wiki/Entorno_de_desarrollo_integrado) que incluye un conjunto de elementos en su interfaz para utilizar de manera mucho más fácil R cuando queremos llevar a cabo análisis estadísticos y explorar datos.
...
Existen [diferentes recomendaciones](https://github.com/posit-dev/positron/discussions/7527) para configurar Positron enfocadas a principiantes. Sin embargo, se recomienda que adoptes la siguiente configuración para Positron:

- Utilizar un tema de color oscuro
- Utilizar la opción dar formato al guardar
