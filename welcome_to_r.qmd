...
<<<<<<< HEAD
Existen [diferentes recomendaciones para principiantes](https://github.com/posit-dev/positron/discussions/7527) respecto a cómo configurar Positron. Para configurar Positron es necesario modificar el archivo de configuración de usuario `settings.json` abriendo la paleta de comandos con {{< kbd Ctrl-Shift-P >}} y escribiendo la opción **Preferences: Open User Settings (JSON)**. A lo largo del libro agregaremos las siguientes opciones en `settings.json`: 
...
>>>>>>> c191b80830555dfc3fb45625d889118888f3a335
