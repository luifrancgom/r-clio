...
1. **Mutating joins** (uniones de transformación en español)
2. **Filtering joins** (uniones de filtrado en español)
3. **Set operations** (operaciones de conjuntos)

Las **Mutating joins** permiten combinar variables de diferentes tablas correspondientes a 2 entidades. En la @sec-mutating-joins utilizando el esquema de la @fig-erd a partir de los archivos señalados en la @nte-1-chap-11 reconstruirás el archivo `2021-2024_saber-pro-genericas_faedis.rds` que se indicó en la @nte-1-chap-6 utilizando este tipo de verbos.

### **Filtering joins**

Las **Filtering joins** buscan coincidencias entre registros de la misma manera que las **Mutating joins**, pero afectan a las observaciones y no a las variables. Existen dos tipos:
