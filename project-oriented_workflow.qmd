...
Este capítulo se basa en [@bryan_what_2025, cap. 3, 5] y tiene como propósito ... Exploraremos los siguientes aspectos:
...
Para generar un proyecto de R en Positron, utiliza la combinación de teclas {{< kbd Ctrl+Shift+P >}} para desplegar la paleta de comandos y escribe: **Workspaces: New Folder from Template...**. Luego, podrás presionar esta opción y elegir a continuación **R project** para realizar las configuraciones respectivas de tu proyecto.
